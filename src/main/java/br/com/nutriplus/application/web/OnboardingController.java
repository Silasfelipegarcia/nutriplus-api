...
import br.com.nutriplus.application.service.OnboardingService;
import br.com.nutriplus.domain.model.UserProfile;
import br.com.nutriplus.application.web.dto.OnboardingDTO;
...
public class OnboardingController {
    ...
    public ResponseEntity<Void> onboard(@RequestBody @Valid OnboardingDTO request) {
