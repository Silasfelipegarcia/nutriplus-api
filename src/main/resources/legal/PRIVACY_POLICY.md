...
CNPJ: **[PREENCHER]**  
E-mail do encarregado (DPO): **[PREENCHER — privacidade@nutriplus.com]**
...
- **Consentimento** para dados sensíveis de saúde e uso do app
- **Execução de contrato** para prestação do serviço
- **Legítimo interesse** para segurança e logs técnicos, quando aplicável

## 5. Compartilhamento

Podemos compartilhar dados com:

- **Provedores de IA** (ex.: Groq, OpenAI) — apenas o necessário para gerar sugestões, sob contratos de processamento
...
Você pode solicitar: confirmação de tratamento, acesso, correção, exclusão, portabilidade e revogação do consentimento. Use o e-mail do encarregado ou a função **Excluir minha conta** no app.
...
Publicaremos versões atualizadas e, quando necessário, solicitaremos novo consentimento.

## 11. Contato

**[PREENCHER — privacidade@nutriplus.com]**
